function abrirAula(card){
    ...
    if(idVideo == 1){  
        ...
        <div class="videoAula">
                <input type="checkbox" id="porcentagem_input" onclick="alterarProgresso()"><p>Após assistir o video, marque a caixa para sabermos quantos porcentos você está avançando no curso</p>
        </div>`;       
    }
    else if(idVideo == 2){
        boxes.innerHTML = `
